...
namespace Automation.Testing
{
    ...
    public class SeleniumSample
    {
        ...
        {
            var driver = new WebDriverFactory(new DriverParams { Driver = "edge", Binaries = @"C:\Users\User\CSharpProjects\AutomationRoot\Automation.Testing\Resources\web-drivers" }).Get();
            driver.Manage().Window.Maximize();
            driver.Navigate().GoToUrl("https://gravitymvctestapplication.azurewebsites.net/");
            driver.FindElement(By.XPath("//a[.='Students']")).Click();
            Thread.Sleep(2000);
